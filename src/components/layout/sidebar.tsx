...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/hr/payroll-config', label: 'Payroll Config', icon: Database },
      { href: '/hr/presensi', label: 'Presensi', icon: Clock },
      { href: '/hr/leave-overtime', label: 'Cuti & Lembur', icon: CalendarDays },
      { href: '/hr/rekrutmen', label: 'Rekrutmen', icon: UserRoundSearch },
      { href: '/hr/reimburse', label: 'Reimburse', icon: Receipt },
      { href: '/hr/kpi', label: 'KPI', icon: Target },
      { href: '/hr/appraisal', label: 'Appraisal', icon: Award },
